...
> **Prerequisites:** [Docker](https://docs.docker.com/get-docker/) installed, basic terminal knowledge. **Recommended:** Read the previous parts in this series: [Part 1: Fundamentals]({{< relref "docker-dockerfile-fundamentals" >}}), [Part 2: Multi-Stage Builds]({{< relref "docker-multi-stage-builds" >}}), [Part 3: Security]({{< relref "docker-security-users" >}}), [Part 4: Build Performance]({{< relref "docker-build-performance" >}}).
...
|------|-------|-------------|
| [1]({{< relref "docker-dockerfile-fundamentals" >}}) | Fundamentals | FROM, COPY, RUN, CMD, and layer ordering |
| [2]({{< relref "docker-multi-stage-builds" >}}) | Multi-Stage Builds | Separate build from runtime to shrink images |
| [3]({{< relref "docker-security-users" >}}) | Security & Users | Non-root users, minimal bases, secrets handling |
| [4]({{< relref "docker-build-performance" >}}) | Build Performance | Cache mounts, parallel stages, .dockerignore |
