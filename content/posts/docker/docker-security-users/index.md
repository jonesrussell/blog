...
> **Prerequisites:** [Docker](https://docs.docker.com/get-docker/) installed, basic terminal knowledge. **Recommended:** Read [Part 1: Writing Your First Dockerfile]({{< relref "docker-dockerfile-fundamentals" >}}) and [Part 2: Multi-Stage Builds]({{< relref "docker-multi-stage-builds" >}}) first.
