...
> **Prerequisites:** [Docker](https://docs.docker.com/get-docker/) installed, basic terminal knowledge. **Recommended:** Read [Part 1](/docker-dockerfile-fundamentals/) and [Part 2](/docker-multi-stage-builds/) first.
