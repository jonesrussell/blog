...
### 1. [Provision an Ubuntu VPS and Create a Deploy User](https://jonesrussell.github.io/blog/provision-ubuntu-vps-deploy-user/)

Droplet creation, deploy user, UFW baseline, and unattended upgrades. The "before you do anything else" checklist.

### 2. [SSH Hardening: Ed25519 Keys and Disabling Root Login](https://jonesrussell.github.io/blog/ssh-hardening-ed25519-disable-root/)
