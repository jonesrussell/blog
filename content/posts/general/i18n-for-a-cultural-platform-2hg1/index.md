---
categories: []
date: "2026-03-23T01:31:18.241Z"
devto: true
devto_id: 3386521
draft: true
slug: i18n-for-a-cultural-platform-2hg1
...
> **Series context:** This is part 8 of the [Waaseyaa series](https://jonesrussell.github.io/blog/waaseyaa-intro/). The previous post covered [replacing the database layer](https://jonesrussell.github.io/blog/waaseyaa-dbal-migration/). This post covers internationalization — the subsystem that makes [Minoo](https://minoo.live) a multilingual platform, with full Ojibwe translation at [minoo.live/oj/](https://minoo.live/oj/).
...
A `null` return means "I don't have an opinion." The negotiation pipeline moves to the next source. This mirrors the neutral-result pattern from [access control](https://jonesrussell.github.io/blog/waaseyaa-access-control/) — no opinion means defer, not default.
...
[Testing a growing package ecosystem at scale](https://jonesrussell.github.io/blog/waaseyaa-testing/).
