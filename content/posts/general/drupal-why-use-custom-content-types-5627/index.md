...
tags:
    ...
    - php
    - beginners
title: Drupal, Why Use Custom Content Types?
---
Structure Content.

{% embed https://youtu.be/tXug3sR0Vfw %} 

In Drupal, a custom content type is a **predefined structure** used to create and organize content on your website.

Content types define the _fields, layout, and settings_ for the content you want to publish.
