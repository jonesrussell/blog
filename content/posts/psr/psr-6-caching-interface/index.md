...
This post is part of our [PSR Standards in PHP series]({{< relref "psr-standards-in-php-practical-guide-for-developers" >}}). If you're new here, you might want to start with [PSR-1]({{< relref "psr-1-basic-coding-standard" >}}) for the basics.
