...
> **Prerequisites:** PHP OOP. **Required:** Read [PSR-7]({{< relref "psr-7-http-message-interfaces" >}}) and [PSR-17]({{< relref "psr-17-http-factories" >}}) first. PSR-18 sends PSR-7 requests and receives PSR-7 responses.
...
We've completed the HTTP stack! Next: [PSR-6: Caching Interface]({{< relref "psr-6-caching-interface" >}}) -- making your application faster with standardized caching.
