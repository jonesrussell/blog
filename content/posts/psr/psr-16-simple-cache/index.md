...
This post is part of our [PSR Standards in PHP series]({{< relref "psr-standards-in-php-practical-guide-for-developers" >}}).

> **Prerequisites:** PHP OOP. **Recommended:** Read [PSR-6]({{< relref "psr-6-caching-interface" >}}) first for comparison.
...
Next: [PSR-13: Hypermedia Links]({{< relref "psr-13-hypermedia-links" >}}) — making your REST APIs self-documenting with standardized link relations.
