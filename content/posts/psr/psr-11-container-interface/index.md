...
> **Prerequisites:** PHP OOP (classes, interfaces, constructors). **Recommended:** Read [PSR-4]({{< relref "psr-4-autoloading-standard" >}}) and [PSR-3]({{< relref "psr-3-logger-interface" >}}) first.
