...
> **Prerequisites:** PHP OOP. **Required:** Read [PSR-7]({{< relref "psr-7-http-message-interfaces" >}}) first -- PSR-17 creates the objects PSR-7 defines.
...
Now that we can create requests and responses, let's process them: [PSR-15: HTTP Handlers and Middleware]({{< relref "psr-15-http-handlers" >}}) -- building a middleware pipeline.
