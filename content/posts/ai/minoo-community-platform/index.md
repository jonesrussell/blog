...
- **Data sovereignty** — Community data stays under community control. There's a dedicated [data sovereignty page](https://minoo.live/data-sovereignty) that explains the approach.
- **Creative Commons licensing** — Community content is shared under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/), so it can't be commercialized without permission.
...
The site is live at [minoo.live](https://minoo.live) and the foundation is in place. Communities in the Espanola area are represented, the Elder Support flow works end to end, and the location-aware search is functional.
...
If you have thoughts, visit [minoo.live](https://minoo.live) and drop a comment or send me a message. Miigwech.
