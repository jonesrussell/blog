...
> **Series context:** This is part 4 of the [Waaseyaa series](/waaseyaa-intro/). This post builds on [the entity system](/waaseyaa-entity-system/) and [access control](/waaseyaa-access-control/) from earlier in the week.
