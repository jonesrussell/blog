...
> **Series context:** This is part 2 of the [Waaseyaa series](/waaseyaa-intro/). Read [part 1](/waaseyaa-intro/) for an overview of the framework, its architecture, and the GitHub issue workflow used to build it.
