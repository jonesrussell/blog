...
> **Series context:** This is part 5 of a five-part series on [Codified Context]({{< relref "codified-context-the-problem" >}}). This post assumes you've read the full series — [the problem]({{< relref "codified-context-the-problem" >}}), [the constitution]({{< relref "codified-context-constitution" >}}), [specialist skills]({{< relref "codified-context-specialist-skills" >}}), and [cold memory]({{< relref "codified-context-cold-memory" >}}).
