...
> **Series context:** This is part 6 of the [Waaseyaa series](/waaseyaa-intro/). Previous posts covered the [entity system](/waaseyaa-entity-system/), [access control](/waaseyaa-access-control/), the [API layer](/waaseyaa-api-layer/), and the [AI packages](/waaseyaa-ai-packages/).
