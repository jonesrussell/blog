...
> **Series context:** This is the final part of the [Waaseyaa series](/waaseyaa-intro/). The week covered the [entity system](/waaseyaa-entity-system/), [access control](/waaseyaa-access-control/), and the [API layer](/waaseyaa-api-layer/).
