...
The structure that works, from the [codified-context skills]({{< relref "codified-context-skills" >}}):
...
Next: [Part 4: Cold memory]({{< relref "codified-context-cold-memory" >}}) — how specs and MCP retrieval handle the architectural knowledge that's too large for either the constitution or a skill.
