...
- Read these planning docs in ~/dev/blog/docs/plans/2026-04-20-content-pipeline-unification/: README.md, 00-overview.md, 01-adr-universal-consumer-split.md, 02-contracts.md, workstreams/W1a.md.
...
- Commit planning updates separately from NC code.",
      "tasks": [
        ...
        {
          "id": "W1a.T3",
          "title": "Envelope schema test + contract-code parity",
          "repos": ["north-cloud"],
          "status": "not-started",
          "assigned_session": "",
          "blockers": [],
...
- Commit blog (and any NC) changes. If this closes the initiative, update 00-overview.md's Definition of Done accordingly.",
  ...
  "schema_version": 1
}; window.STATUS_GENERATED_AT = "2026-04-20T18:27:21Z";
