# Social copy: Wiring Spec Drift Detection Into Your Monorepo

**Canonical URL:** https://jonesrussell.github.io/blog/wiring-spec-drift-detection-into-your-monorepo/
...
Spec drift is a silent problem in monorepos. The docs exist, the mapping exists, but nobody checks if they're current. This post walks through wiring a drift detector into Taskfile, lefthook, and GitHub Actions as a hard gate across every enforcement surface. https://jonesrussell.github.io/blog/wiring-spec-drift-detection-into-your-monorepo/
